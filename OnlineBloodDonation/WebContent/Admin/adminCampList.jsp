		...
		<div class="container-table100">
		 <div class="wrap-table100">	
				...
				<div class="wrap-table100-nextcdols js-pscroll">	
						<div class="table100-nextcols">
							<table border="2px">
								...
								<tr class="row100 head">
										...
										<th class="cell100 column2">RegId</th>
										<th class="cell100 column3">Camp Name</th>
										<th class="cell100 column4">Location</th>
										<th class="cell100 column5">Status</th>
										<th class="cell100 column5">Email Id</th>
				 ...
				 ArrayList<CampDto> campinfo =AdminBl.getCamp();

if(campinfo!=null && (campinfo.size()>0))

  {
	
	 for(CampDto campinf: campinfo )

	  {
	    ...
	    %>
								 ...
								 <tbody>
									<tr class="row100 body">
									<td>
									<input type="submit" value="Approve" name="submit" onClick="Javascript:window.location.href = 'emailSend.jsp?campid=<%=campinf.getRegid()%>';">  
					 			</td>
					        	<td class="column2">
					            <input type="submit" value="Reject" name="submit" onClick="Javascript:window.location.href = 'rejectedusers.jsp?campid=<%=campinf.getRegid() %>';">  
									</td>
										<td class="cell100 column2"><%=campinf.getRegid() %></td>
										<td class="cell100 column3"><%=campinf.getCampname()%></td>
										<td class="cell100 column4"> <%=campinf.getLocation() %> </td>
										<td class="cell100 column5"><%=campinf.getStatus()%></td>
											<td class="cell100 column5"><%=campinf.getEmail()%></td>
