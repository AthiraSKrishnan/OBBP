...
out.println(campid);
campdto=new CampDto();
campdto=CampBl.approvecamp(campid);
//String email1="anoopsuresh161@gmail.com";
String email1=campdto.getEmail();
out.println(email1);
...
try
{
	CampDto campdt=new CampDto();
	campdt.setRegid(campid);
	campdt.setStatus(1);
	result1=CampBl.updatestatus(campdt);
	DloginDto login=new DloginDto();
	login.setUsername(campid);
	login.setStatus(1);
	...
	response.sendRedirect("adminCampList.jsp");
}
catch(Exception e)
{
